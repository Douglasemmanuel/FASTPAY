...
const CardTransaction = () => {
  ...
  return (
    ...
    <Text style={{color:'grey' , marginLeft:15 , marginTop:10 , fontSize:15 , fontWeight:'bold' , flex:3.5}}>Transactions</Text>
   ...
   <Text style={{color:'grey' , marginLeft:15 , marginTop:10 , fontSize:15 , fontWeight:90}}>See All</Text>
    ...
    <View style={{flexDirection:'row' , marginLeft:15, marginTop:10 }}>
     ...
     <Text style={{fontWeight:'bold' ,fontSize:14}}>Just registered</Text>
      ...
      <View style={{borderRadius:50 ,backgroundColor:'black' , width:50 , height:20  , marginLeft:150 }}>
